 ...
 <!-- SignUp start-->
		...
		<div class="container">
			...
			<div class="container">
				...
				<input id="text" type="text" placeholder="Enter New Username" name="username" required>
				<label id="text" for="psw"><b>Password</b></label>
				<input id="text" type="password" placeholder="Enter New Password" name="password" required>   
				<button id="button" type="submit">Signup</button>
				<label>
				<br>
				<h4>Already have an account?</h4>
                <a href="<?php echo url('login.php'); ?>" class="btn btn-primary py-2 px-2">Login</a>
				<h6><br></h6>
				</label>
			</div>
			</form>
