		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="<?php echo url('service.php'); ?>" class="nav-item nav-link active">Service</a>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
						    ...
						    <i class="fa fa-3x fa-utensils text-primary mb-4"></i>
                                ...
                                <p>Explore and Discover restaurants around you to enjoy different cuisines</p>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
							...
							<i class="fa fa-3x fa-cart-plus text-primary mb-4"></i>
                                <h5>Menu!</h5>
                                <p>Check out the specialities of their special chefs and their updated daily specials</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
							...
							<i class="fa fa-3x fa-user-tie text-primary mb-4"></i>
								<h5>Check Reviews</h5>
                                <p>Before going to restaurant, check other people's reviews on the place</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Table Vacancy</h5>
                                <p>Check how many of the tables are already in use or reserved</p>
                            </div>
                        </div>
                    </div>
					<!--
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>Reserve your favourite table for your favourite time for your favourite occasion</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>Choose the right table for the right number of people o enjoy with</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-cart-plus text-primary mb-4"></i>
                                <h5>Cancel or Reschedule</h5>
                                <p>You are flexible to cancel or reschedule a reservation a day priorly</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-headset text-primary mb-4"></i>
                                <h5>Give Review</h5>
                                <p>Everyone likes honest reviews, share your experience about food and the ambience</p>
                            </div>
                        </div>
                    </div> -->
                </div>
